...
return (
  <div className={`min-h-[89vh] flex justify-center ${mode === "dark" ? "text-white bg-neutral-900" : "text-black bg-white"}`}>
    <div className={`m-4 w-full ${mode === "light" ? "bg-slate-200" : "bg-neutral-900"} max-w-lg rounded-md p-8`}>
      <h2 className="text-2xl font-bold text-center mb-8">Add a new Recipe</h2>
